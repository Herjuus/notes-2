            ...
            <div className="z-20 p-5 bg-slate-300/20 rounded drop-shadow-md w-80 space-y-2">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex justify-between gap-1 font-light">
                        <input value={directoryPath} onChange={(e) => setDirectoryPath(e.target.value)} type="text" className="outline-none rounded px-2 text-xs bg-gray-950/10 flex-1" />
                ...
                <button onClick={() => saveConfig(directoryPath)} className="bg-gray-950/10 hover:bg-gray-950/15 text-sm h-fit p-1 rounded text-gray-100 w-full">Save</button>
            </div>
